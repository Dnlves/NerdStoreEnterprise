...
namespace NSE.WebApp.MVC.Services
{
    public interface IAutenticacaoService
    {
        ...
        Task RealizarLogin(UsuarioRespostaLogin usuarioResposta);
        Task Logout();
        bool TokenExpirado();
    ...
    public class AutenticacaoService : Service, IAutenticacaoService
    {
        ...
        public async Task RealizarLogin(UsuarioRespostaLogin usuarioResposta)
        {
            var token = ObterTokenFormatado(usuarioResposta.AccessToken);

            var claims = new List<Claim>();
            claims.Add(new Claim("JWT", usuarioResposta.AccessToken));
            claims.Add(new Claim("RefreshToken", usuarioResposta.RefreshToken));
